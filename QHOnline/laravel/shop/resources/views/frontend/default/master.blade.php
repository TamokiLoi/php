    ...
    <div class="wrapper">
        ...
        <nav class="top-bar animate-dropdown">
            <div class="container">
                <div class="col-xs-12 col-sm-6 no-margin">
                    <ul>
                        <li><a href="http://tamoki.store/">Home</a></li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li role="presentation"><a role="menuitem" class="changecolor dark-green-text"
                                        tabindex="-1" href="#" title="Darkgreen color">Dark Green</a></li>
                            </ul>
                        </li>
                    ...
                    <ul class="right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Turkish Lira (TL)</a>
                                </li>
        ...
        <header>
                    ...
                    <div class="yamm navbar">
                        ...
                        <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-hover="dropdown"
                                        data-toggle="dropdown">Computers</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#">Computer Cases &amp; Accessories</a></li>
                                        <li><a href="#">CPUs, Processors</a></li>
                                        <li><a href="#">Fans, Heatsinks &amp; Cooling</a></li>
            ...
            <div class="animate-dropdown">
                <!-- ===== BREADCRUMB ===== -->
                <div id="breadcrumb-alt" style="margin-bottom: -31px;">
                    <div class="container">
                        <div class="breadcrumb-nav-holder minimal">
                            <ul>
                                ...
                                <li class="dropdown breadcrumb-item">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">laptops &amp; computers
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="#">PDA</a>
                ...
                <div class="container">
                    ...
                    <div class="col-xs-12 col-sm-6 no-margin">
                        <div class="payment-methods ">
                            <ul>
                                <li><img alt=""
                                        src="{{ asset('themes/default/assets/images/payments/payment-visa.png') }}">
                                </li>
                                <li><img alt=""
                                        src="{{ asset('themes/default/assets/images/payments/payment-master.png') }}">
                                </li>
                                <li><img alt=""
                                        src="{{ asset('themes/default/assets/images/payments/payment-paypal.png') }}">
                                </li>
                                <li><img alt=""
                                        src="{{ asset('themes/default/assets/images/payments/payment-skrill.png') }}">
                                </li>
                            </ul>
                        </div><!-- /.payment-methods -->
                    </div>
