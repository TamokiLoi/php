            ...
            <div class="side-menu animate-dropdown">
                ...
                <nav class="yamm megamenu-horizontal" role="navigation">
                    <ul class="nav">
                        ...
                        <li>
                            <a
                                href="http://themeforest.net/item/media-center-electronic-ecommerce-html-template/8178892?ref=shaikrilwan">Buy
                                this Theme</a></li>
                    </ul><!-- /.nav -->
        ...
        <div class="col-xs-12 col-sm-8 col-md-9 homebanner-holder">
            ...
            <div id="hero">
                <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                    ...
                    <div class="item"
                        style="background-image: url({{ asset('themes/default/assets/images/sliders/slider-1.jpg') }});">
                    ...
                    <div class="item"
                        style="background-image: url({{ asset('themes/default/assets/images/sliders/slider-2.jpg') }});">
                        <div class="container-fluid">
                            <div class="caption vertical-center text-left">
                                {{-- <div class="big-text fadeInDown-1">
                    ...
                    <div class="item"
                        style="background-image: url({{ asset('themes/default/assets/images/sliders/slider-3.jpg') }});">
                        <div class="container-fluid">
                            <div class="caption vertical-center text-left">
                                {{-- <div class="big-text fadeInDown-1">
                                    Want a<span class="big"><span class="sign">$</span>200</span>Discount?
    ...
    <div class="container">
        <div class="col-xs-12 col-lg-6 no-margin banner">
            <a href="category-grid-2.html">
                ...
                <img class="banner-image" alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                    data-echo="{{ asset('themes/default/assets/images/banners/banner-narrow-1.jpg') }}" />
            </a>
        </div>
        <div class="col-xs-12 col-lg-6 no-margin text-right banner">
            <a href="category-grid-2.html">
                ...
                <img class="banner-image" alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                    data-echo="{{ asset('themes/default/assets/images/banners/banner-narrow-2.jpg') }}" />
            </a>
        </div>
    </div><!-- /.container -->
                        ...
                        <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="body">
                                    ...
                                    <div class="title">
                                        <a
                                            href="{{ route('frontend.home.show', ['slug' => str_slug($product->name), 'id' => $product->id]) }}">
                                            {{ $product->name }}
                                        </a>
                                    </div>
